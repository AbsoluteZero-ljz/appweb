...
<head>
  <title>Embedthis Appweb Public API</title><!-- BeginDsi "dsi/meta.html" -->
  <meta name="keywords" content=
  "embedded web server, web server software, embedded HTTP, application web server, embedded server" />
  <meta name="description" content=
  "Embedthis Sofware provides embedded web servers for devices and applications." />
  <meta name="robots" content="index,follow" /><!-- EndDsi -->
...
<body leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
  ...
  <div class="background">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td><img src="../../../images/backLeft.png" width="400" height="93"
        alt="" border="0" ismap="ismap" usemap="#home" /><map name="home" id=
        "home">
          <area coords="0,0,93,93" href=
          "../../../product/publicApi/index.html" />
        </map></td>

        <td width="100%"><img src="../../../images/backMiddle.png" width=
        "100%" height="93" alt="" border="0" /></td>

        <td><img src="../../../images/backRight.png" width="354" height="93"
        alt="" border="0" /></td>
      </tr>
    </table>
  </div>
  ...
  <div class="navTop">
    <table cellpadding="0" cellspacing="0" border="0" align="top">
      <tr>
        <td valign="bottom"><a href="http://www.mbedthis.com/" class=
        "navTop">Embedthis Home</a> |&nbsp;</td>

        <td valign="bottom"><a href="../../../index.html" class=
        "navTop">Documentation Home</a> |&nbsp;</td>

        <td valign="bottom"><a href=
        "../../../guide/users/admin/overview.html" class=
        "navTop">Administration</a> |&nbsp;</td>

        <td valign="bottom"><a href="overview.html" class=
        "navTop">Programmers Reference</a></td>
...
?>
      ...
      <td class="contentSideBar">
        <div class="linkSection">
          <h2>See Also</h2><!-- BeginDsi "dsi/api.html" -->
...
<!-- BeginDsi "dsi/terms.html" -->
  <p class="terms"><a href="../../../product/copyright.html">&copy; Embedthis
  Software LLC, 2003-2007. All rights reserved. Embedthis is a trademark of
  Embedthis Software LLC.</a></p>
<!-- EndDsi -->
</body>
</html>
