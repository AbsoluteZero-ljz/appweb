#
#   appweb-core-linux-static.mk -- Makefile to build Embedthis Appweb Core for linux
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-linux-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-linux-static-me.h >/dev/null ; then\
		cp projects/appweb-core-linux-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
