...
$(BUILD)/obj/phpHandler5.o: \
    src/appweb-php/phpHandler5.c $(DEPS_37)
...
$(BUILD)/obj/phpHandler7.o: \
    src/appweb-php/phpHandler7.c $(DEPS_38)
...
DEPS_57 += $(BUILD)/obj/phpHandler5.o
DEPS_57 += $(BUILD)/obj/phpHandler7.o
...
$(BUILD)/bin/libmod_php.dylib: $(DEPS_57)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libmod_php.dylib -compatibility_version 7.1 -current_version 7.1 "$(BUILD)/obj/phpHandler5.o" "$(BUILD)/obj/phpHandler7.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) -lpam 
endif
