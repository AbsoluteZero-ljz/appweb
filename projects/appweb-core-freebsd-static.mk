#
#   appweb-core-freebsd-static.mk -- Makefile to build Embedthis Appweb Core for freebsd
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-freebsd-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-freebsd-static-me.h >/dev/null ; then\
		cp projects/appweb-core-freebsd-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
