...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform windows-x64-openssl_11 -configure . --set openssl.version=1.1 --with openssl --with esp --with cgi --with fast --with ssl -gen vs"
#endif
