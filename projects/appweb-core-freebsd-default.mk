#
#   appweb-core-freebsd-default.mk -- Makefile to build Embedthis Appweb Core for freebsd
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-freebsd-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-freebsd-default-me.h >/dev/null ; then\
		cp projects/appweb-core-freebsd-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
