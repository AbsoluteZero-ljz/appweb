#
#   appweb-core-macosx-static.mk -- Makefile to build Embedthis Appweb Core for macosx
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-macosx-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-macosx-static-me.h >/dev/null ; then\
		cp projects/appweb-core-macosx-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
