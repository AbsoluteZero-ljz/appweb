...
$(BUILD)/bin/appweb-esp.out: $(DEPS_63)
	...
	$(CC) -o $(BUILD)/bin/appweb-esp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/esp.o" $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/http.out: $(DEPS_65)
	...
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/http.o" $(LIBPATHS_65) $(LIBS_65) $(LIBS_65) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/libmod_fast.a: $(DEPS_68)
...
$(BUILD)/bin/makerom.out: $(DEPS_71)
	...
	$(CC) -o $(BUILD)/bin/makerom.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/makerom.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -Wl,-r 

#
#   server
#
ifeq ($(ME_COM_HTTP),1)
    DEPS_72 += $(BUILD)/bin/libhttp.a
endif
...
$(BUILD)/bin/server.out: $(DEPS_72)
	...
	$(CC) -o $(BUILD)/bin/server.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/server.o" $(LIBPATHS_72) $(LIBS_72) $(LIBS_72) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/appman.out: $(DEPS_74)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) -Wl,-r 
endif
