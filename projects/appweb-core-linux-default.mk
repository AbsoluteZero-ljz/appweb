#
#   appweb-core-linux-default.mk -- Makefile to build Embedthis Appweb Core for linux
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-linux-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-linux-default-me.h >/dev/null ; then\
		cp projects/appweb-core-linux-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/bin/libappweb.so: $(DEPS_51)
	...
	$(CC) -shared -o $(BUILD)/bin/libappweb.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" "$(BUILD)/obj/rom.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) 
...
$(BUILD)/bin/libmod_php.so: $(DEPS_59)
	...
	$(CC) -shared -o $(BUILD)/bin/libmod_php.so $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/phpHandler5.o" "$(BUILD)/obj/phpHandler7.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) 
endif
...
installBinary: $(DEPS_65)
	...
	cp installs/linux/appweb-core.init $(ME_ROOT_PREFIX)/etc/init.d/appweb-core ; \
	chmod 755 "$(ME_ROOT_PREFIX)/etc/init.d/appweb-core" ; \
