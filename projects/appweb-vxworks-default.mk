#
#   appweb-vxworks-default.mk -- Makefile to build Embedthis Appweb Enterprise Edition for vxworks
#
...
$(BUILD)/bin/libmpr.out: $(DEPS_53)
	...
	$(CC) -r -o $(BUILD)/bin/libmpr.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprLib.o" -lmpr-openssl $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/libhttp.out: $(DEPS_55)
	...
	$(CC) -r -o $(BUILD)/bin/libhttp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/httpLib.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libesp.out: $(DEPS_57)
	@echo '      [Link] $(BUILD)/bin/libesp.out'
	$(CC) -r -o $(BUILD)/bin/libesp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/espLib.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
#
ifeq ($(ME_COM_ESP),1)
    DEPS_58 += $(BUILD)/bin/libesp.out
endif
ifeq ($(ME_COM_SQLITE),1)
    DEPS_58 += $(BUILD)/bin/libsql.out
endif
ifeq ($(ME_COM_HTTP),1)
...
$(BUILD)/bin/libappweb.out: $(DEPS_58)
	@echo '      [Link] $(BUILD)/bin/libappweb.out'
	$(CC) -r -o $(BUILD)/bin/libappweb.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" "$(BUILD)/obj/rom.o" $(LIBPATHS_58) $(LIBS_58) $(LIBS_58) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/appweb.out: $(DEPS_59)
	@echo '      [Link] $(BUILD)/bin/appweb.out'
	$(CC) -o $(BUILD)/bin/appweb.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/appweb.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/authpass.out: $(DEPS_60)
	@echo '      [Link] $(BUILD)/bin/authpass.out'
	$(CC) -o $(BUILD)/bin/authpass.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/authpass.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 

ifeq ($(ME_COM_ESP),1)
#
#   espcmd
#
DEPS_61 += $(BUILD)/bin/libesp.out
ifeq ($(ME_COM_SQLITE),1)
    DEPS_61 += $(BUILD)/bin/libsql.out
endif
...
$(BUILD)/bin/appweb-esp.out: $(DEPS_61)
	@echo '      [Link] $(BUILD)/bin/appweb-esp.out'
	$(CC) -o $(BUILD)/bin/appweb-esp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/esp.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
...
$(BUILD)/bin/http.out: $(DEPS_63)
	...
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/http.o" $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
...
$(BUILD)/bin/libmod_fast.out: $(DEPS_66)
	@echo '      [Link] $(BUILD)/bin/libmod_fast.out'
	$(CC) -r -o $(BUILD)/bin/libmod_fast.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/fastHandler.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/makerom.out: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/makerom.out'
	$(CC) -o $(BUILD)/bin/makerom.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/makerom.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/server.out: $(DEPS_69)
	@echo '      [Link] $(BUILD)/bin/server.out'
	$(CC) -o $(BUILD)/bin/server.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/server.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/appman.out: $(DEPS_71)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" -lmpr-openssl $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
