...
$(BUILD)/bin/libappweb.out: $(DEPS_60)
	...
	$(CC) -r -o $(BUILD)/bin/libappweb.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" "$(BUILD)/obj/rom.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/libmod_fast.out: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/libmod_fast.out'
	$(CC) -r -o $(BUILD)/bin/libmod_fast.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/fastHandler.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libmod_php.out: $(DEPS_69)
	...
	$(CC) -r -o $(BUILD)/bin/libmod_php.out $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/phpHandler5.o" "$(BUILD)/obj/phpHandler7.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/makerom.out: $(DEPS_71)
	@echo '      [Link] $(BUILD)/bin/makerom.out'
	$(CC) -o $(BUILD)/bin/makerom.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/makerom.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/server.out: $(DEPS_72)
	@echo '      [Link] $(BUILD)/bin/server.out'
	$(CC) -o $(BUILD)/bin/server.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/server.o" $(LIBPATHS_72) $(LIBS_72) $(LIBS_72) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/appman.out: $(DEPS_74)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" -lmpr-openssl $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
