#
#   appweb-core-vxworks-default.mk -- Makefile to build Embedthis Appweb Core for vxworks
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-core-vxworks-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-core-vxworks-default-me.h >/dev/null ; then\
		cp projects/appweb-core-vxworks-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/bin/libmpr.out: $(DEPS_46)
	...
	$(CC) -r -o $(BUILD)/bin/libmpr.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprLib.o" -lmpr-openssl $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/libhttp.out: $(DEPS_48)
	...
	$(CC) -r -o $(BUILD)/bin/libhttp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/httpLib.o" $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libesp.out: $(DEPS_50)
	...
	$(CC) -r -o $(BUILD)/bin/libesp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/espLib.o" -lmpr-version $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libappweb.out: $(DEPS_51)
	...
	$(CC) -r -o $(BUILD)/bin/libappweb.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" "$(BUILD)/obj/rom.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/appweb.out: $(DEPS_52)
	...
	$(CC) -o $(BUILD)/bin/appweb.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/appweb.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/authpass.out: $(DEPS_53)
	...
	$(CC) -o $(BUILD)/bin/authpass.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/authpass.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/appweb-esp.out: $(DEPS_54)
	...
	$(CC) -o $(BUILD)/bin/appweb-esp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/esp.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
...
$(BUILD)/bin/http.out: $(DEPS_56)
	...
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/http.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
...
$(BUILD)/bin/libmod_php.out: $(DEPS_59)
	...
	$(CC) -r -o $(BUILD)/bin/libmod_php.out $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/phpHandler5.o" "$(BUILD)/obj/phpHandler7.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lmpr-version -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/makerom.out: $(DEPS_60)
	...
	$(CC) -o $(BUILD)/bin/makerom.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/makerom.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/appman.out: $(DEPS_63)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" -lmpr-openssl $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
