...
static int getDirList(MaRequest *rq, MaDirEntry **list, int *count, const char *path, bool enumDirs);
...
static int getDirList(MaRequest *rq, MaDirEntry **list, int *count, const char *dir, bool enumDirs)
{
